...
export function ProfileTabs({ username }: ProfileTabsProps) {
  ...
  return (
    <div className="relative border-b border-border">
      ...
      {/* Hints that the tab bar scrolls — otherwise the last tab or two look clipped rather than "more content this way", especially on mobile where all 10 tabs never fit. */}
