...
export const copy = {
  ...
  auth: {
    ...
    googleSignupCta: "Continue with Google",
    noAccountPrompt: "Don't have an account?",
    hasAccountPrompt: "Already have an account?",
    verifyEmailTitle: "Verify your email",
    verifyEmailBody: "We sent a 6-digit code to your email. Enter it below to verify your account.",
    verifyEmailCodeLabel: "Verification code",
    verifyEmailCta: "Verify",
  ...
  transcriber: {
    ...
    copiedCta: "Copied",
    noSpeech: "No speech was detected in this video.",
    errorTooLong: "This video is longer than the transcription limit.",
    errorUnsupported: "This link isn't from a supported platform.",
    errorPrivate: "Couldn't access this video — it may be private, deleted, or region-restricted.",
    errorGeneric: "Couldn't transcribe this video right now. Please try again shortly.",
    languageLabel: "Spoken language",
    languageHint: "Auto-detect works for almost every video — only change this if it picks the wrong language.",
    translateLabel: "Translate to",
    translateCta: "Translate",
    translatingCta: "Translating…",
    translateErrorGeneric: "Couldn't translate this transcript right now. Please try again shortly.",
